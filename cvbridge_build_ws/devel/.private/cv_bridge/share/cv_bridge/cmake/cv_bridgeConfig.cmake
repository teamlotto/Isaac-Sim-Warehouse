...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /root/cvbridge_build_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /root/cvbridge_build_ws/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /root/cvbridge_build_ws/install)
...
if(NOT "/root/cvbridge_build_ws/src/vision_opencv/cv_bridge/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/root/cvbridge_build_ws/src/vision_opencv/cv_bridge/include;/usr/include;/usr/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/cvbridge_build_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/cvbridge_build_ws/devel/.private/cv_bridge/lib;/root/cvbridge_build_ws/install/lib;/root/Project/LottiNavigation/devel/lib;/opt/ros/melodic/lib)
